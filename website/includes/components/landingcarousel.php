<div id = "outerWrap">
        ...
        <div id="carousel-background" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="images/stock2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
    ...
    <div id = "layer3">
        <div class = "container landing-content">
            ...
            <p><b>Grocery<i class="bi bi-basket3-fill egg-icon"></i>Pool</b> is different from other food delivery services in that it focuses on community relationships first. The convenience model of food delivery is detrimental to the environment, and can be unprofitable because the convenience model suffers from inefficiencies that result from redundant driving. <b>Grocery<i class="bi bi-basket3-fill egg-icon"></i>Pool</b> does the opposite and aims to reduce these inefficiencies through careful localization and scheduling.</p>
...
<<<<<<< HEAD
                            ...
                            <div class = "infographics">
                                <i class="bi bi-person-circle accent-color"></i>
                                <i class="bi bi-cart-fill small"></i>
