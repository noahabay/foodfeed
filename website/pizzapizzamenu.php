...
<!-- <div class="jumbotron jumbotron-fluid"> -->
  <div class="container-menu">
        ...
        <h2>Pizza Pizza</h2>
        <h6>Ratings: 4.9 | Italian </h6>
        <h6> Open Until 11:30 pm </h6>
  </div>
<!-- </div> -->
<main>
    ...
    <div class="card">
      ...
      <div class="container">
        ...
        <p><form id="form3" action="mycart.php" method="POST">
                <input type="hidden" name="pizza_id" value="3">
                <button type="submit" class="button">Add to cart</button>
            </form></p>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <h2>Cauli-blossom Pizza, 2 Coke, 1 Dip</h2>
        ...
        <p><form id="form4" action="mycart.php" method="POST">
                <input type="hidden" name="pizza_id" value="4">
                <button type="submit" class="button">Add to cart</button>
            </form></p>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <h2>Veggie Pizza, 2 Coke, 1 Dip</h2>
        ...
        <p><form id="form6" action="mycart.php" method="POST">
                <input type="hidden" name="pizza_id" value="6">
                <button type="submit" class="button">Add to cart</button>
            </form></p> 
      </div>
    </div>
